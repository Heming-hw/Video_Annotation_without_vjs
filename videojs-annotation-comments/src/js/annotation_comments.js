...
module.exports = () => {
  ...
  return class AnnotationComments {
    ...
    bindEvents() {
      ...
      this.player.addEventListener('fullscreenchange', Utils.throttle(this.setBounds.bind(this), 500))
    ...
    toggleAnnotationMode() {
      ...
      const div = document.getElementsByClassName("video_wrap")
      div[0].classList.toggle("vac-active");
      // this.player.classList.toggle('vac-active');
